...
// How long to paint the change region (scrolled into view, highlighted) before
// the new content is applied. Tweak this to make the anticipation longer/shorter.
export const ANTICIPATE_HOLD_MS = 1000;
